...
module.exports = {
  ...
  tagline: 'Course Notes for Web Programming Foundations',
  url: 'https://patrick-crawford.github.io',
  baseUrl: '/WebProgrammingFoundations',
  trailingSlash: false,
  onBrokenLinks: 'warn',
  onBrokenMarkdownLinks: 'warn',
  favicon: 'img/favicon.ico',
  organizationName: 'SDDS',
  projectName: 'WebProgrammingFoundations',
  themeConfig: {
    navbar: {
      title: 'Web Programming Foundations',
      logo: {
      ...
      links: [
        {
          ...
          items: [
            ...
            {
              html: `<a href='./pdf/WebProgrammingFoundations.pdf' id='download-pdf' class='footer__link-item' download='Web-Programming-for-Apps-and-Services.pdf'>Download Notes (PDF)</a>`,
            },
          ],
        },
      ],
