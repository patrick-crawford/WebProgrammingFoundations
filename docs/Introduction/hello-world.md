...
As you may have guessed from above, the first web technology we will learn is JavaScript. JavaScript (often shortened to JS)
...
> **NOTE:** JavaScript is dynamic, and variables can change value _and_ type at runtime:
>
> ```js
> let a; // undefined
> a = 6; // 6, Number
